...
bench_args(Version, _) ->
    %ets_usage_scenarios_test:list_of_scenarios(Version).
...
run([ets_usage_scenarios, TableType, NrOfOperations, KeyRangeSize, Scenario, ConcurrencyOptions, WorkerHeapSize|_], _, _) ->
    ets_usage_scenarios_test:run_bench(TableType, NrOfOperations, KeyRangeSize, Scenario, ConcurrencyOptions, WorkerHeapSize);
